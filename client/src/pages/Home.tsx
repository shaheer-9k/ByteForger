...
import { Zap, Lightbulb, Target, Rocket, Trophy, Users, Award, Gem, CheckCircle, Sparkles } from "lucide-react";
    ...
    <div className="w-full min-h-screen flex flex-col">
      ...
      <main>
        ...
        <section className="py-16 sm:py-20 md:py-28 bg-gradient-to-r from-darkBlue via-blue-800 to-lightBlue text-white relative overflow-hidden">
          <div className="absolute inset-0 bg-gradient-to-br from-gray-900 to-darkBlue opacity-90"></div>
          <div className="max-w-6xl mx-auto px-4 sm:px-6 md:px-8 text-center relative z-10">
            ...
            <motion.div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 sm:gap-6 mt-12 sm:mt-16">
              {[
                { icon: Zap, title: "Proven Execution", desc: "Agile methodology with guaranteed delivery", testid: "card-rapid-development" },
                { icon: Lightbulb, title: "Strategic Innovation", desc: "Enterprise-grade technology solutions", testid: "card-innovation" },
                { icon: Target, title: "Committed Partnership", desc: "Your goals drive our success", testid: "card-partnership" },
              ].map((item, idx) => (
                <motion.div
                  key={idx}
        ...
        <section id="services">
          ...
          >
            <div className="text-center mb-12 sm:mb-16 mt-16 sm:mt-20 px-4 sm:px-6">
              <h2 className="text-3xl xs:text-4xl sm:text-5xl font-bold font-play text-darkBlue dark:text-lightBlue mb-4">
                Our Expertise
              </h2>
                    ...
                    <div className="group h-full bg-gradient-to-br from-white/95 to-gray-50 dark:from-gray-800 dark:to-gray-900 rounded-3xl shadow-xl dark:shadow-2xl dark:shadow-gray-900 p-8 flex flex-col items-center justify-center transition-all duration-500 overflow-hidden relative border border-gray-200 dark:border-gray-700 hover:border-lightBlue dark:hover:border-neonPink hover:shadow-2xl dark:hover:shadow-3xl hover:bg-gradient-to-br hover:from-slate-50 hover:to-blue-50/50">
                      ...
                      <div className="relative z-10 w-full flex flex-col items-center h-full justify-center">
                        <div className="mb-6 p-5 bg-gradient-to-br from-darkBlue/15 to-lightBlue/15 dark:from-neonPink/20 dark:to-lightBlue/20 rounded-3xl group-hover:scale-120 group-hover:from-darkBlue/25 group-hover:to-lightBlue/25 dark:group-hover:from-neonPink/30 dark:group-hover:to-lightBlue/30 transition-all duration-300 shadow-lg">
                          <Icon className="w-10 h-10 sm:w-12 sm:h-12 md:w-14 md:h-14 text-darkBlue dark:text-neonPink group-hover:text-lightBlue dark:group-hover:text-cream transition-colors duration-300" />
                        </div>
                        <p className="font-bold font-play text-center text-lg md:text-2xl text-darkBlue dark:text-lightBlue mb-4 group-hover:text-darkBlue dark:group-hover:text-cream transition-colors duration-300">
                          {service.title}
                        </p>
        ...
        <section id="methodology" className="bg-darkBlue mt-20 relative overflow-hidden py-24">
          ...
          <div className="container mx-auto px-4 max-w-7xl relative z-10">
            ...
            <motion.div
              ref={ref2}
              className={`grid grid-cols-1 md:grid-cols-2 gap-8 justify-items-center transition-opacity ease-in duration-700 ${isVisible2 ? "opacity-100" : "opacity-0"
                }`}
              initial={{ opacity: 0 }}
              ...
              <div className="flex flex-wrap justify-center items-center mx-4 md:justify-evenly md:mx-20 space-y-4 lg:mx-44 md:space-y-0 mb-12 max-w-4xl mx-auto">
                {Object.keys(techStack).map((category) => (
                  <button
                    ...
                    className={`font-semibold text-center my-2 md:my-4 ${selectedCategory === category ? "text-lightBlue" : "text-foreground"
        ...
        <section id="about" className="mt-20 py-24 px-4 sm:px-6 md:px-8 bg-gray-50 dark:bg-gray-900 relative">
          ...
          <div className="max-w-7xl mx-auto relative z-10">
            ...
            >
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8 lg:w-5/6 mx-auto">
                ...
                >
                  <div className="mb-4 text-neonPink">
                ...
                >
                  <div className="mb-4 text-darkPink">
            ...
            >
              ...
              <div className="space-y-4 sm:space-y-6">
                {[
                  { icon: Target, title: "Outcome-Driven Approach", desc: "Strategic alignment at every stage. We establish clear objectives and deliver solutions that drive measurable business impact." },
                  { icon: Zap, title: "Enterprise Agility", desc: "Rapid iteration without compromise. Our proven methodologies ensure on-time delivery while maintaining production-grade quality." },
                  { icon: Rocket, title: "Advanced Expertise", desc: "Deep technical mastery across modern software architecture, cloud infrastructure, and digital transformation disciplines." },
                  { icon: Gem, title: "Uncompromising Quality", desc: "Enterprise-grade standards applied to every project. We deliver robust, scalable solutions engineered for long-term performance." },
                ].map((item, idx) => (
                  <motion.div
                    key={idx}
                  ...
                  >
                    <div className="flex-shrink-0 animate-bounce-slow" style={{ animationDelay: `${idx * 0.1}s` }}>
                      <item.icon className="w-8 h-8 sm:w-9 sm:h-9 text-darkBlue dark:text-lightBlue" />
                    </div>
            ...
            >
              {[
                ...
                <motion.div
                  key={idx}
                  className="text-center p-4 sm:p-6 bg-gradient-to-br from-slate-900 to-slate-800 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 border border-gray-700 hover:border-neonPink hover:scale-105"
                  initial={{ opacity: 0, y: 20 }}
                  whileInView={{ opacity: 1, y: 0 }}
                  transition={{ delay: idx * 0.1, duration: 0.5 }}
                >
                  <div className="text-3xl sm:text-4xl md:text-5xl font-bold font-play bg-gradient-to-r from-blue-400 to-neonPink bg-clip-text text-transparent mb-2 sm:mb-3">
                    {stat.number}
                  </div>
                  <p className="text-xs sm:text-sm md:text-base text-white font-semibold">{stat.label}</p>
                  <div className="mt-2 flex justify-center">
                    <stat.icon className="w-8 h-8 sm:w-10 sm:h-10 text-gray-400" />
                  </div>
                </motion.div>
              ))}
            </motion.div>
            ...
            >
              ...
              <div className="relative z-10">
                ...
                <p className="text-cream/95 text-base sm:text-lg md:text-xl leading-relaxed mb-8 sm:mb-10 max-w-3xl mx-auto font-light">
                  At ByteForger, we don't just build software—we forge strategic digital assets that transform businesses.
                  Partner with us to build the future.
                </p>
                <Link href="/contact">
                  <span className="inline-block px-6 sm:px-8 py-2 sm:py-3 bg-white text-darkBlue font-bold font-play rounded-full hover:scale-105 transition-transform duration-300 shadow-lg hover:shadow-xl cursor-pointer text-sm sm:text-base">
